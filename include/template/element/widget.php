	...
	<script type="text/html" id="tmpl-grid-element-widget">
		...
		switch ( widget_class.toLowerCase() ) {
			case 'wp_widget_media_image':
				if ( !! instance.url ) {
					info_style += ' style="';
					info_style += "background-image:url('" + instance.url + "');";
					info_style += "background-repeat:no-repeat;";
					info_style += "background-size:cover;";
					info_style += "background-position:center center;";
					info_style += '" ';
		...
		<div class="info" <# print( info_style ) #>>
